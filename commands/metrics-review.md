---
name: metrics-review
description: Review and analyze product metrics with trend analysis and actionable insights. Use when running a weekly or monthly metrics check, identifying concerning trends, or preparing a metrics summary for stakeholders.
...
If an analytics tool is connected:
...
See the **metrics-tracking** command for frameworks on building a metrics hierarchy.

### 3. Analyze Trends

For each key metric:
- **Current value**: What is the metric today?
- **Trend**: Up, down, or flat compared to the previous period? Over what timeframe?
...
- Metrics where visibility or understanding is lacking.
...
- Metrics you should be tracking but are not yet.
