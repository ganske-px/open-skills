...
description: Generate a stakeholder update tailored to audience and cadence — weekly, monthly, launch, or ad-hoc. Use when preparing a regular status update, announcing a launch, communicating a pivot, or drafting an executive summary.
...
If a meeting transcription tool is connected:
...
- If a chat tool is connected, offer to draft the message for sending
