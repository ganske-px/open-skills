---
name: roadmap-update
description: Update or reprioritize an existing product roadmap — add items, change statuses, shift timelines, or build one from scratch. Use when running a roadmap review, reacting to changed priorities, or preparing a roadmap update for stakeholders.
...
- If a project management tool is connected, offer to update ticket statuses
